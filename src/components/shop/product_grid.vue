...
<template>
	<div id="productGridContainer" class="w-full flex items-center justify-center">
		<div class="w-full lg:w-4/5 px-8 py-10 flex flex-col lg:flex-row items-start justify-center">
			...
			<div class="w-full lg:hidden flex items-center justify-center">
				<div class="w-full h-auto px-3.5 py-2.5 flex items-center justify-center">
					<button ref="asideOpenButton"
						class="group w-full px-3.5 py-2.5 rounded-md flex items-center justify-center dark:bg-stone-700 hover:dark:bg-red-400">
			...
			<aside ref="aside"
				class="hidden lg:block w-full h-full sm:w-1/2 md:w-1/3 sm:h-full lg:w-[22.5%] lg:h-auto px-8 py-10 lg:px-3.5 lg:py-2.5 text-left fixed lg:sticky left-0 right-0 bottom-0 lg:top-0 sm:border-r-[3px] lg:border-none border-orange-200 dark:border-stone-700 bg-stone-800 lg:bg-transparent">
