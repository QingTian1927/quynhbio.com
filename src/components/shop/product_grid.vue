		...
		<div class="w-full lg:w-4/5 px-8 py-10 flex flex-col lg:flex-row items-start justify-center">
			<div class="w-full lg:hidden flex items-center justify-center">
				<div class="w-full h-auto px-3.5 py-2.5 flex items-center justify-center">
					<button ref="asideOpenButton" class="group w-full px-3.5 py-2.5 rounded-md flex items-center justify-center dark:bg-stone-700 hover:dark:bg-red-400">
						<div class="flex items-center justify-center mr-2">
							<svg xmlns="http://www.w3.org/2000/svg" width="1.2rem" height="1.2rem" class="bi bi-sliders fill-stone-800 dark:fill-orange-100 group-hover:fill-stone-800" viewBox="0 0 16 16">
			...
			<aside ref="aside" class="hidden lg:block w-full h-full sm:w-1/2 md:w-1/3 sm:h-full lg:w-[22.5%] lg:h-auto px-8 py-10 lg:px-3.5 lg:py-2.5 text-left fixed lg:sticky left-0 right-0 bottom-0 lg:top-0 sm:border-r-[3px] lg:border-none border-orange-200 dark:border-stone-700 bg-stone-800 lg:bg-transparent">
				<div class="flex items-center justify-between lg:justify-start">
					<h2 class="inline font-bold text-2xl leading-6">Bộ Lọc</h2>
					<button ref="asideCloseButton" class="inline lg:hidden ml-2 font-bold text-2xl leading-6 hover:text-red-300 dark:hover:text-red-400">⨉</button>
				</div>
			...
			<section class="w-full lg:w-[77.5%] px-3.5 py-2.5">
				...
				<div class="w-full grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-2 xl:grid-cols-3 gap-6 items-stretch">
					<div v-for="product of props.catalogue.products" class="w-full aspect-[4/5] flex flex-col items-center justify-between rounded-lg bg-orange-200 dark:bg-stone-700">
