...
export const ui = {
	en: {
		...
		'shop.filterForm.nameAsc': 'Product: A-Z',
		'shop.filterForm.nameDesc': 'Product: Z-A',
		'shop.filterForm.categoryAsc': 'Category: A-Z',
		'shop.filterForm.categoryDesc': 'Category: Z-A',
		...
		'shop.pageNav.prev': 'Go to previous page',
		'shop.pageNav.next': 'Go to next page',
		'shop.pageNav.first': 'Go to first page',
		'shop.pageNav.last': 'Go to last page',
	...
	vi: {
		...
		'shop.filterForm.nameAsc': 'Sản phẩm: A-Z',
		'shop.filterForm.nameDesc': 'Sản phẩm: Z-A',
		'shop.filterForm.categoryAsc': 'Măt hàng: A-Z',
		'shop.filterForm.categoryDesc': 'Măt hàng: Z-A',
		...
		'shop.pageNav.prev': 'Sang trang phía trước',
		'shop.pageNav.next': 'Sang trang tiếp theo',
		'shop.pageNav.first': 'Sang trang đầu tiên',
		'shop.pageNav.last': 'Sang trang cuối cùng',
